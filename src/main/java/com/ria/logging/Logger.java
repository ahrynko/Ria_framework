...
public class Logger {
    ...
    private final org.apache.log4j.Logger logger; // обертка над log4j.Logger

    public Logger() {
        logger = org.apache.log4j.Logger.getLogger(Logger.class.getName());
    }

    public void trace(final Object message) {  // метод trace
        logger.trace(message);    // вызов trace из -apache.log4j
    }
